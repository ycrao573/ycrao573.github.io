...
export const createTimelineItems = (t: (key: string) => string): ExperienceItem[] => [
  ...
  },
  {
    ...
    details: [t('experience.adsk.b1'), t('experience.adsk.b2')],
  ...
  },
  {
    ...
    details: [t('experience.lzd.b1'), t('experience.lzd.b2'), t('experience.lzd.b3')],
  ...
  },
  {
    ...
    details: [t('experience.sea.b1'), t('experience.sea.b2'), t('experience.sea.b3')],
  ...
  },
  {
    badges: [
      ...
      { href: 'https://langchain-ai.github.io/langgraph/', label: 'LangGraph' },
      { label: 'AI' },
    ],
    date: t('experience.nas.date'),
    details: [t('experience.nas.b1'), t('experience.nas.b2'), t('experience.nas.b3')],
    logo: 'https://www.google.com/s2/favicons?domain=nas.com&sz=128',
    logoAlt: 'NAS',
    role: t('experience.nas.role'),
    title: t('experience.nas.company'),
  },
];
