      ...
      <section id="resume">
        ...
        <div className="row skill">
          ...
          <div className="nine columns main-col techtree">
            <h3>{skillmessage}</h3>
            <ul className="bgrid-quarters s-bgrid-thirds">
              ...
              <div className="columns feature-item">
                ...
                <h5>ReactJS</h5>
                <p>
                  several web projects and{" "}
                  <a href="https://www.yuchen-rao.ml/">THIS WEBSITE</a>!
                </p>
              </div>
              <div className="columns feature-item">
                <img
                  className="skill"
                  alt="Docker"
                  src="https://avatars.githubusercontent.com/u/11618900?s=460&u=4094ca922dc10a0476cd0eaf37aa78d3c7a91eb2&v=4"
                />
                <h5>Docker</h5>
              ...
              <div className="columns feature-item">
                <img
                  className="skill"
                  alt="Jenkins"
                  src="https://www.pngitem.com/pimgs/m/340-3408094_jenkins-ci-hd-png-download.png"
                />
                <h5>Jenkins</h5>
              ...
              <div className="columns feature-item">
                ...
                />
                <h5>Golang</h5>
                <p>used for SCIM e2e testing</p>
              </div>
              <div className="columns feature-item">
                <img
                  className="skill"
                  alt="SQL"
                  src="https://i0.wp.com/www.mobileatom.net/wp-content/uploads/2020/04/MySQL-Square-300.png?resize=300%2C300&ssl=1"
                />
                <h5>MySQL</h5>
              ...
              <div className="columns feature-item">
                <img
                  className="skill"
                  alt="pr"
                  src="https://img.pngio.com/adobe-premiere-pro-logo-png-and-vector-logo-download-adobe-premiere-pro-png-700_682.png"
                />
                <h5>Premiere Pro</h5>
